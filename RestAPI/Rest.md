...
| Pragma         | Pragma: no-cache                                  | no-cache                                           | Used for backward compatibility with HTTP/1.0 caches to ensure that a request bypasses the cache. | use in legace systems supporting HTTP/1.0 clients |
