...
3. **modules, require, import/export** - each module wrapped in func(exports,require,module,__filename,__dirname){ur code; return module.exports}, hence global!=global, use gloval.varnm (avoid it), require -commonJS, import-ES6 (similar to JS import), export - (in JS export const abc, in node exports.ab), module.exports = obj/fun, import vs require - (import - selectively load data and loading is async), 
