...
Log Group
└── /aws/ec2/my-web-app
    ├── i-0123456789abcdef0    ← Log Stream (EC2 Instance 1)
    ├── i-0fedcba9876543210    ← Log Stream (EC2 Instance 2)
    └── i-0abc123def4567890    ← Log Stream (EC2 Instance 3)
```

- **Application Load Balancer (ALB):** Routes requests to multiple EC2 instances.
- **Log Group:** `/aws/ec2/my-web-app`
- **Log Stream:** One per EC2 instance (typically named using the EC2 Instance ID).
- **Log Events:** Application or system logs generated by that EC2 instance.
