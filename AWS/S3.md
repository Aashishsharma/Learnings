...
> - **S3 storage lens** - helps analyze and optimize **only** S3 bucket's storage across entire AWS Org. It can aggregate all data from all buckets and create reports, which we can use to optimize cost
