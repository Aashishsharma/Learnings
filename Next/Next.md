...
1. **Client components** - Same as React components we use in React, **but these client components can be rendered as SSR, meaning HTML is genereated on server and later JS is sent and then Hydration is done for those components**
